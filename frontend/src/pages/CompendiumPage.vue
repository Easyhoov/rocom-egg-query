...
const selectedAttr = ref((route.query.attribute as string) || '')
const selectedEggGroup = ref((route.query.egg_group as string) || '')
...
const eggGroups = ref<{ egg_group_name: string; spirit_count: number }[]>([])
